...
<head>
    ...
    <title>DentaText - Text Message Reminders for Dentists</title>
    <meta name="description" content="DentaText allows dentists to send text message reminders to their patients instead of wasting time and money on direct mail techniques.">
...
<body>
	...
	<script type="text/javascript">
	  var _gaq = _gaq || [];
	  _gaq.push(['_setAccount', 'UA-10670512-17']);
